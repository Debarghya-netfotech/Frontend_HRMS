    ...
    return (
        <div className='flex items-center justify-center h-screen'>
            <div className=' max-w-sm mx-auto p-8 bg-white border rounded-xl  shadow-[6px_6px_20px_0px_rgba(0,0,0,0.12)]'>
                ...
                <form className='mt-8'>
                    <div className='mb-3'>
                        <label className="w-full flex flex-col justify-center h-[20px] text-[var(--Teal,#378BA6)] font-jost text-[16px] font-bold leading-[130%] tracking-[0.08px]">Create Password *</label>
                    ...
                    <div className='mt-3'>
                        <label className="w-full flex flex-col justify-center h-[20px] text-[var(--Teal,#378BA6)] font-jost text-[16px] font-bold leading-[130%] tracking-[0.08px]">Confirm Password *</label>
                        <input type="text" className="w-full border border-[var(--Teal,#378BA6)] rounded-lg px-4 py-2 focus:outline-none focus:border-[var(--Teal,#378BA6)] text-[var(--Teal,#378BA6)]" placeholder='********' />
                    </div>
                </form>
