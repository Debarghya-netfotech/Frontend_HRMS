...
const MonthlyDashboard = () => {
  return (
    ...
    <div className='flex flex-col items-start gap-3 p-6 px-10 rounded-br rounded-bl shadow-lg mb-6'>
      <div className="flex items-center justify-between w-[100%] p-4 bg-white">
      ...
      <div className='flex flex-col justify-center items-center gap-4 self-stretch'>
        <div className="flex flex-row w-[100%] items-center gap-3">
          <div className='flex p-[11.796px] items-center gap-[17.693px] flex-1 rounded-[5.898px] bg-[#FBEFD0] w-[325px] h-[65.85px]'>
      ...
      <div className='w-[100%] flex flex-row items-center  gap-10'>
        <h1 className='text-[#4F4F4F] font-jost text-[18px] font-semibold '>USER RATING</h1>
        <div className='flex w-[775px] h-[100px] p-[12px_16px] justify-center items-center gap-[40px] flex-shrink-0 rounded-[4px] bg-[#EAF1F3]'>
