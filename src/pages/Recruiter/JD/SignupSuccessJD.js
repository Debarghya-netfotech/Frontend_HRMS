    ...
    return (
      <div className="flex justify-center items-center h-screen">
        <div className="bg-white bop-8 rounded-lg shadow-lg text-center p-12">
          ...
          <p className="text-[#1B1B25] font-Jost text-lg font-normal leading-normal">JD Locked and added to Workplace!</p>
        </div>
      </div>
    );
  }

export default SignupSuccessJD
