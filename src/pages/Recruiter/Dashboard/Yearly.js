...
const Yearly = () => {
  return (
    ...
    <div className='flex flex-col items-start gap-3 py-2 px-4 rounded-br rounded-bl shadow-lg mb-6'>
      <div className="flex items-center justify-between w-[100%] p-1 bg-white">
